...
def main():
    ...
    datasets_group.add_argument("--no-webp",dest="webp",action="store_false",help="Specified if dataset is not using webp in sceneflow sets")
    ...
    model_group.add_argument("--save",dest="save",action="store",help="Path to file in which data should be saved")
    model_group.add_argument("--load",dest="load",action="store",help="Path to file which should be loaded")
    ...
    eval_group.add_argument("--result-path",dest="result",type=str, help="Path under which the result will be saved")
